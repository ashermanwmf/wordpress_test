...
jQuery(window).bind('load', function(){
	...
	jQuery(document).on('widget-added widget-updated', function(){
		...
		jQuery('#accordion-section-sidebar-widgets-front_sidebar span.button-secondary.add-new-widget').attr('data-widget-count',widgetcount);
		jQuery('#accordion-section-sidebar-widgets-front_sidebar dl').attr('data-dl-count',widgetcount);
		jQuery('div#widgets-left.frontsidebarlimit').removeClass('frontsidebarlimit');
		//DO NOT REMOVE THIS (BUG FIX)
		jQuery('#accordion-section-sidebar-widgets-front_sidebar .add-new-widget').toggle(function() {
			jQuery( '#widgets-left').addClass('frontsidebarlimit');
		},function(){
			jQuery( '#widgets-left').removeClass('frontsidebarlimit');
		});
